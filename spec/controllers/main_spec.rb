...
RSpec.describe MainController, type: :controller do
  ...
  describe "dashboard" do 
    ...
    it 'counts correct number of validated teachers' do 
      expect(@controller_stub.instance_variable_get(:@validated_teachers).size).to equal 2
    end

    it 'shows correct course statistics' do 
      #both validated and denied teachers are accounted for in statuses.
      ...
      expect(statuses["I am teaching BJC but not as an AP CS Principles course."]).to equal 1
